...
abstract class AbstractEndpoint implements EndpointInterface {
	...
	*/
	...
	/**
	* Validates if a username is valid, throws a Exception\InvalidUsername exception if invalid
	*$useranme
	* @link https://veridu.com/wiki/Introduction#Basic_Concepts
	*
	* @param string $username User identification
	...
	* @return boolean
	*/
	public static function validateValidUsernameOrFail($username) {
	...
	* @return boolean
	*/
	public function validateUsernameOrFail($username) {
		if (self::validateNotEmptyUsernameOrFail($username) && self::validateValidUsernameOrFail($username))
			return true;
		return false;
	}
